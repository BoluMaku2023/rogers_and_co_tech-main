  ...
  return (
    <>
      ...
      <div className="sw-foreground">
        <Fade bottom>
          <div className="imagebox__image">
            <img src="./solar1.jpg" alt="Rogers&Co." />
          </div>
        </Fade>
      ...
      <div className="sw-foreground2">
        ...
        <Fade bottom>
          <div className="imagebox__image">
            <img src="./solar2.jpg" alt="MData Solutions" />
          </div>
        </Fade>
      </div>
      <section className="div">
        <div className="img-housing2">
          <Fade bottom>
            <div className="imagebox__image">
              <img src="./solar3.webp" alt="Rogers&Co." />
            </div>
          </Fade>
        </div>
        ...
        <Fade bottom>
          <div className="imagebox__image">
            <img src="./solar4.webp" alt="Rogers&Co." />
          </div>
        </Fade>
