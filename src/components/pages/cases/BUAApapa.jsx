    ...
    <>
        ...
        <div className="paddings innerWidth flexCenter hero-container">
          ...
          <div className="hero-left">
            <div className="hero-title">
              <h1>BUA Sugar Refinery (Apapa)</h1>
            </div>
              ...
              <div className="about-list">
                <Fade left>
                  <div className="a-list-item">
                    <span>Customer</span>
                    <h2>BUA Sugar Refinery (Apapa)</h2>
                  </div>
                </Fade>
                <Fade left>
                  <div className="a-list-item">
      ...
      <section className="hero2-wrapper-new">
        ...
        <div ref={(el) => (containerr = el)} className="containerr">
          <div className="a-hero-video">
            <img ref={(el) => (image = el)} src="./fire2.jpg" alt="BUA Sugar" />
          </div>
        </div>
      </section>
      ...
      <div className="sw-foreground">
        <Fade bottom>
          <div className="imagebox__image">
            <img src="./fire1.jpg" alt="Rogers&Co." />
          </div>
        </Fade>
      ...
      <section className="div">
        <div className="img-housing2">
          <Fade bottom>
            <div className="imagebox__image">
              <img src="./fire4.jpg" alt="Rogers&Co." />
            </div>
          </Fade>
        </div>
