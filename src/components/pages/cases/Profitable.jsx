  ...
  return (
    <>
            ...
            <div className="flexColStart hero-des">
              <div className="about-list">
                ...
                <Fade left>
                  <div className="a-list-item">
                    <span>Website</span>
                    <a href="https://profitable.com/" target="blank">
                      profitable.com
                    </a>
                  </div>
                </Fade>
      ...
      <div className="sw-foreground">
        <Fade bottom>
          <div className="imagebox__image">
            <img src="./profit1.png" alt="Rogers&Co." />
          </div>
        </Fade>
              ...
              <div className="sw-label-section">
                ...
                <div className="label-des">
                  <Slide bottom delay={500}>
                    ...
                    <span>
                      Furthermore, the application provides customizable
                      reporting features, enabling businesses to generate
                      detailed financial reports tailored to their specific
                      requirements. By doing so, it empowers stakeholders at all
                      levels to gain a holistic view of the organization's
                      financial health, identify trends, uncover potential areas
                      for optimization, and strategically allocate resources for
                      sustainable growth.
                    </span>
                  </Slide>
                </div>
      ...
      <div className="sw-foreground2">
        ...
        <Fade bottom>
          <div className="imagebox__image">
            <img src="./profit5.png" alt="MData Solutions" />
          </div>
        </Fade>
      </div>
      <section className="div">
        <div className="img-housing2">
          <Fade bottom>
            <div className="imagebox__image">
              <img src="./profit-mk1.png" alt="Rogers&Co." />
            </div>
          </Fade>
        </div>
        ...
        <Fade bottom>
          <div className="imagebox__image">
            <img src="./profit-mk2.png" alt="Rogers&Co." />
          </div>
        </Fade>
